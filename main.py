...
label_formularz.grid(row=0, column=1)

label_imie=Label(ramka_formularz, text='Imie')
label_imie.grid(row=1, column=0, columnspan=2)
...
label_imie_szczegoly_obiektow=Label(ramka_szczegoly_obiektow, text='Imie')
